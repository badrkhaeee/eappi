...
global $gLog;
	...
	{
	$_SESSION['oslc_version'] 	= _h('<Version number not found>');
	}
	else
	{
	...
	$_SESSION['favorites_as_home']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'favorites_as_home', 'false');
	...
	$_SESSION['show_path_button']	= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_path_button', 'true')) ? '1' : '0';
	$_SESSION['show_search']	= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_search', 'true')) ? '1' : '0';
	$_SESSION['show_watchlist']	= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_watchlist', 'true')) ? '1' : '0';
	$_SESSION['filter_properties'] 	= 'true';
$_SESSION['selected_features'] = GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, 'selected_features', 'nt');
$_SESSION['feature_order'] = GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, 'feature_order', 'nt,tv,lt,fl,ra,mf,ch,dm,df,is,tk,ev,dc,dr');
$_SESSION['propsview_hide_empty'] = GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, 'propsview_hide_empty', 'true');
$_SESSION['search_settings'] = GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, 'search_settings', json_encode(['category'=>'diagram', 'type'=>'name', 'when'=>'-3d']) );
$_SESSION['add_object_selection'] = GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, 'add_object_selection', json_encode(['type'=>'package', 'technology'=>'', 'diagram_type'=>'']));
    $sUserBrowserSelection = SafeGetInternalArrayParameter($_SESSION, 'show_browser', '1');
	$sUserPropertiesSelection = SafeGetInternalArrayParameter($_SESSION, 'show_propertiesview', '1');
	if ($sUserBrowserSelection !== '0')
	{
	$_SESSION['show_browser']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_browser', 'true');
	}
	if ($sUserPropertiesSelection  !== '0')
	{
	$_SESSION['show_propertiesview']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_propertiesview', 'true');
	}
	$sSortOrder = SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'object_order', '3');
	if ($sSortOrder === '1')
	{
	$sSortOrder = '';
	}
	...
	{
	$sSortOrder = 'tpos,name';
	}
	else if ($sSortOrder === '3')
	{
	$sSortOrder = 'object_type,tpos,name';
	}
	else
	{
	$sSortOrder = 'object_type,tpos,name';
	}
	$_SESSION['object_order']	= $sSortOrder;
	...
	$_SESSION['prop_visible_files'] = strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'prop_sec_files_visible', 'true')) ? '1' : '0';
	...
	$_SESSION['prop_visible_features'] 	= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'prop_sec_features_visible', 'true')) ? '1' : '0';
	...
	$_SESSION['prop_visible_documents'] = strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'prop_sec_documents_visible', 'true')) ? '1' : '0';
	...
	$_SESSION['show_chat']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_chat', 'false');
	$_SESSION['chat_notify_sec']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_notify_freq', '30');
	$_SESSION['show_mail']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_mail', 'false');
	$_SESSION['show_comments']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'show_comments', 'false');
	$_SESSION['mail_days']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'mail_days', '90');
	...
	$_SESSION['add_objectfeature_features'] = (IsSessionSettingTrue('add_object_features')?SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'add_objectfeature_features', 'false'):'false');
	...
	$_SESSION['add_objectfeature_documents'] = (IsSessionSettingTrue('add_object_features')?SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'add_objectfeature_documents', 'false'):'false');
	...
	$_SESSION['collaborate_tab'] = SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'collaborate_tab', 'chat');
	$_SESSION['chat_name']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_name', '');
	$_SESSION['chat_type']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_type', '');
	$_SESSION['chat_monitor']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_monitor', '');
	$_SESSION['chat_days']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_days', 'Today+');
	$_SESSION['chat_history_timeframe']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'chat_history_timeframe', '7');
	$_SESSION['review_history_timeframe']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'review_history_timeframe', '7');
	$_SESSION['discussion_history_timeframe']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'discussion_history_timeframe', '7');
	$_SESSION['comment_history_timeframe']	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'comment_history_timeframe', '7');
	...
	$_SESSION['add_objectfeature_features'] = 'false';
	$_SESSION['add_objectfeature_changes'] = 'false';
	$_SESSION['add_objectfeature_documents'] = 'false';
	...
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_feature_verified', 'false')) ? 'featureverified=1;' : 'featureverified=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_feature_requested', 'false')) ? 'featurerequested=1;' : 'featurerequested=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_feature_completed', 'false')) ? 'featurecompleted=1;' : 'featurecompleted=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_feature_new', 'false')) ? 'featurenew=1;' : 'featurenew=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_feature_incomplete', 'false')) ? 'featureincomplete=1;' : 'featureincomplete=0;';
	...
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_document_verified', 'false')) ? 'documentverified=1;' : 'documentverified=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_document_requested', 'false')) ? 'documentrequested=1;' : 'documentrequested=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_document_completed', 'false')) ? 'documentcompleted=1;' : 'documentcompleted=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_document_new', 'false')) ? 'documentnew=1;' : 'documentnew=0;';
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_document_incomplete', 'false')) ? 'documentincomplete=1;' : 'documentincomplete=0;';
	...
	$sWatchListOptions .= strIsTrue(SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, 'wl_event_high', 'false')) ? 'eventnew=1;' : 'eventnew=0;';
	...
	function GetVarFromCookieOrConfig($aSettings, $sModelNameInConfig, $sVariable, $sDefault = '')
	{
	$sValue = '';
	if (isset($_COOKIE[$sVariable]))
	{
	$sValue = $_COOKIE[$sVariable];
	}
	else
	{
	$sValue	= SafeGetArrayItem2DimByName($aSettings, $sModelNameInConfig, $sVariable, $sDefault);
	}
	return $sValue;
	}
?>