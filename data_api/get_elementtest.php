...
// --------------------------------------------------------
	...
	$sXML .= '  <ss:test>';
	$sXML .= '    <ss:resourceidentifier>' . _x($sParentGUID) . '</ss:resourceidentifier>';
	$sXML .= '    <dcterms:title>' . _x($sTestName) . '</dcterms:title>';
	$sXML .= '    <ss:classtype>' . _x($sTestClass) . '</ss:classtype>';
