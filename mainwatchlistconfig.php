...
// --------------------------------------------------------
	...
	echo '<tr class="watchlist-config-line"><td colspan="3" class="watchlist-config-option-hdr">&nbsp;</td></tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td colspan="2" class="watchlist-config-option-hdr">' . _glt('Features') . '&nbsp;&nbsp;&nbsp;<img alt="" src="images/spriteplaceholder.png" class="propsprite-feature"/></td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Verified') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-featureverified" name="featureverified" ' . IsChecked($aWatchList, 'featureverified') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Recently requested') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-featurerequested" name="featurerequested" ' . IsChecked($aWatchList, 'featurerequested') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Recently completed') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-featurecompleted" name="featurecompleted" ' . IsChecked($aWatchList, 'featurecompleted') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('New') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-featurenew" name="featurenew" ' . IsChecked($aWatchList, 'featurenew') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Incomplete') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-featureincomplete" name="featureincomplete" ' . IsChecked($aWatchList, 'featureincomplete') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line"><td colspan="3" class="watchlist-config-option-hdr">&nbsp;</td></tr>';
	echo '<tr class="watchlist-config-line">';
	...
	echo '<tr class="watchlist-config-line"><td colspan="3" class="watchlist-config-option-hdr">&nbsp;</td></tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td colspan="2" class="watchlist-config-option-hdr">' . _glt('Documents') . '&nbsp;&nbsp;&nbsp;<img alt="" src="images/spriteplaceholder.png" class="propsprite-document"/></td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Verified') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-documentverified" name="documentverified" ' . IsChecked($aWatchList, 'documentverified') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Recently requested') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-documentrequested" name="documentrequested" ' . IsChecked($aWatchList, 'documentrequested') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Recently completed') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-documentcompleted" name="documentcompleted" ' . IsChecked($aWatchList, 'documentcompleted') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('New') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-documentnew" name="documentnew" ' . IsChecked($aWatchList, 'documentnew') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line">';
	echo '<td class="watchlist-config-label field-label-vert-align-top">' . _glt('Incomplete') . '</td>';
	echo '<td class="watchlist-config-field"><input type="checkbox" id="wlc-documentincomplete" name="documentincomplete" ' . IsChecked($aWatchList, 'documentincomplete') . '>&nbsp;</td>';
	echo '</tr>';
	echo '<tr class="watchlist-config-line"><td colspan="3" class="watchlist-config-option-hdr">&nbsp;</td></tr>';
	echo '<tr class="watchlist-config-line">';
