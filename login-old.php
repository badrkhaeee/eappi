...
<?php
	...
	echo '<div style="margin: 50px auto 0px auto;max-width: 650px;border-radius: 5px;font-size: 14px;">';
	echo '<img src="images/logo-2.png" style="max-width: 100%;height:auto">';
	echo '</div>';
	echo '<div id="sign-in" style="margin-top:10px;">';
	...
	echo '<div id="login-desktop" class="login-action-layoutoption-button login-next-button" onclick="OnClickLoginNextButton(this,\'m\')"><img src="images/spriteplaceholder.png" class="mainsprite-login-layout-desktop" alt="" style="width: 35px;"/><div class="login-layoutoption-btn-text" style="padding: 10px 0px 10px 0px;">EAPKTL Live</div></div>';
	echo '<a href="https://docs.google.com/spreadsheets/d/1xJWOJZxFWi7wBXU3qW38v5zV5w_YV2Zm4hZr-eAHj3w/edit?usp=sharing" target="_blank"><div class="login-action-layoutoption-button login-next-button" style="background-color: #AE2727 !important; white-space: nowrap"><img src="images/spriteplaceholder.png" class="mainsprite-login-layout-desktop" alt="" style="background-position: -218px -213px;width: 26px;"/><div class="login-layoutoption-btn-text" style="padding: 10px 0px 0px 0px;">EAPKTL Project Progress</div></div></a>';
	echo '<a href="https://drive.google.com/drive/folders/1y5dTkoUAwnQRbQJfiQ6ZOd1jFz4OExL6?usp=sharing" target="_blank"><div class="login-action-layoutoption-button login-next-button" style="background-color: #000000 !important; white-space: nowrap"><img src="images/spriteplaceholder.png" class="mainsprite-login-layout-desktop" alt="" style="background-position: 8px -212px;"/><div class="login-layoutoption-btn-text" style="padding: 10px 0px 0px 0px;">EAPKTL Repository</div></div></a>';
	echo '</div>';
	echo '<div class="group-button-bawah" style="display: flex; justify-content: center;text-align-last: center;">';
	
	echo '<a href="https://docs.google.com/forms/d/e/1FAIpQLScG6reneZCSHJsOdigNfOhBHUglPxGz8QU0A1GyasM1utG_Eg/viewform" target="_blank"><div class="login-action-layoutoption-button login-next-button" style="background-color: #5984D2 !important; white-space: nowrap;padding-right:7px;"><img src="images/spriteplaceholder.png" class="mainsprite-login-layout-desktop" alt="" style="background-position: 8px -211px;"/><div class="login-layoutoption-btn-text" style="padding: 10px 0px 0px 0px;">Application Survey</div></div></a>';
	echo '<a href="https://docs.google.com/forms/d/e/1FAIpQLSdYwepDPK4zE0kEFHgoOSTTITh2z0pOM9xEG2qr8a1l1Smo7Q/viewform" target="_blank"><div class="login-action-layoutoption-button login-next-button" style="background-color: #4366A4 !important; white-space: nowrap;padding-right:7px;"><img src="images/spriteplaceholder.png" class="mainsprite-login-layout-desktop" alt="" style="background-position: 8px -210px;"/><div class="login-layoutoption-btn-text" style="padding: 10px 0px 0px 0px;">Developer Survey</div></div></a>';
