...
<?php
	...
	$fp = fopen($path, 'w');
	$ini = '; -------------------------------------------------------------------------------------------------'. PHP_EOL;
$ini .= ';  This is a part of the Sparx Systems Pro Cloud Server.'. PHP_EOL;
$ini .= ';  Copyright (C) Sparx Systems Pty Ltd'. PHP_EOL;
$ini .= ';  All rights reserved.'. PHP_EOL;
$ini .= ';'. PHP_EOL;
$ini .= ';  This source code can be used only under terms and '. PHP_EOL;
$ini .= ';  conditions of the accompanying license agreement.'. PHP_EOL;
$ini .= '; -------------------------------------------------------------------------------------------------'. PHP_EOL;
	...
	$sValue	= SafeGetArrayItem2DimByName($aSettings, $sModelName, 'auto_login_windows_auth', 'unset');
	$sTooltip = '"When set to Yes, WebEA will automatically attempt to login using Windows ID (bypassing the login screen with User/Password fields for manual login)."';
	WriteYesNoCombo('auto_login_windows_auth', 'Automatic Windows Login', $sValue, 'false', 'title=' . $sTooltip);
	echo '</div>';
	echo '<div class="config-field-headerandsection">';
	...
	echo '<input id="config-field-chatfreq" class="webea-main-styled-textbox config-field-value" name="chat_notify_sec" title=' . $sTooltip . ' type="number" maxlength="3" style="width: 60px" value="' . _h($sValue) . '">';
	echo '</div>';
	...
	echo '<input id="config-field-maildays" class="webea-main-styled-textbox config-field-value" name="mail_days" title=' . $sTooltip . ' type="number" maxlength="3" style="width: 60px" value="' . _h($sValue) . '">';
	echo '</div>';
