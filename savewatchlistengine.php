...
// --------------------------------------------------------
	...
	$sFeatureVerified	= SafeGetInternalArrayParameter($_POST, 'featureverified');
	$sFeatureRequested	= SafeGetInternalArrayParameter($_POST, 'featurerequested');
	$sFeatureCompleted	= SafeGetInternalArrayParameter($_POST, 'featurecompleted');
	$sFeatureNew	= SafeGetInternalArrayParameter($_POST, 'featurenew');
	$sFeatureIncomplete	= SafeGetInternalArrayParameter($_POST, 'featureincomplete');
	...
	$sDocumentVerified	= SafeGetInternalArrayParameter($_POST, 'documentverified');
	$sDocumentRequested	= SafeGetInternalArrayParameter($_POST, 'documentrequested');
	$sDocumentCompleted	= SafeGetInternalArrayParameter($_POST, 'documentcompleted');
	$sDocumentNew	= SafeGetInternalArrayParameter($_POST, 'documentnew');
	$sDocumentIncomplete	= SafeGetInternalArrayParameter($_POST, 'documentincomplete');
	...
	$sWatchListOptions .= ';featureverified=' . GetCheckboxValue($sFeatureVerified);
	$sWatchListOptions .= ';featurerequested=' . GetCheckboxValue($sFeatureRequested);
	$sWatchListOptions .= ';featurecompleted=' . GetCheckboxValue($sFeatureCompleted);
	$sWatchListOptions .= ';featurenew=' . GetCheckboxValue($sFeatureNew);
	$sWatchListOptions .= ';featureincomplete=' . GetCheckboxValue($sFeatureIncomplete);
	...
	$sWatchListOptions .= ';documentverified=' . GetCheckboxValue($sDocumentVerified);
	$sWatchListOptions .= ';documentrequested=' . GetCheckboxValue($sDocumentRequested);
	$sWatchListOptions .= ';documentcompleted=' . GetCheckboxValue($sDocumentCompleted);
	$sWatchListOptions .= ';documentnew=' . GetCheckboxValue($sDocumentNew);
	$sWatchListOptions .= ';documentincomplete=' . GetCheckboxValue($sDocumentIncomplete);
	...
	setcookie($sCookieName, $sWatchListOptions, time() + (86400 * $iRetentionDays), '/', null, null, true);
