...
<head>
	...
	<link type="text/css" rel="stylesheet" href="styles/custom-eapktl.css" />
...
<body>
	...
	echo '	<div class="contextmenu-item" onclick="OnLogoff(this)"><div class="hamburger-logout-icon"><div class="hamburger-item-text logout-text">' . _glt('Logout') . '</div></div></div>';
	echo '</div>';
	include('hamburger.php');
	echo '	</div>';
	echo '	<div id="header-right">';
	echo '	<div id="project-title" class="d-none">';
	echo '<div id="main-db-icon" class="d-none"><img src="images/db-icon.png" alt="" height="16" width="16"/></div>';
	echo '<div class="mainsprite-home32white" onclick="LoadHome(false)"></div><div id="project-title-text"><a class="d-none">' . _h($modelName) . '</a></div></div>';
	echo '<div id="navigation" class="navigation">
	<a href="#" class="menu-text nav-item"> </a>
	<a href="#" class="menu-text nav-item"> </a>
	<a href="#" class="menu-text nav-item"> </a>
	</div>';
	echo '	</div>';
	...
	echo '<div id="full-busy-loader"><img src="images/mainwait.gif" alt="" class="main-spinner" height="300" width="300"></div>';
