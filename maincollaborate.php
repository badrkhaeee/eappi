...
// --------------------------------------------------------
	...
	{
	echo  '<div class="disabled-collab-message">';
	echo  _glt('Select an element from the comment history');
	echo  '</div>';
	}
	echo '</div>';
	}
	...
	{
	echo  '<div class="disabled-collab-message">';
	echo  _glt('Select an element from the discussion history');
	echo  '</div>';
	}
	echo '</div>';
	}
	...
	{
	echo  '<div class="disabled-collab-message">';
	echo  _glt('Select an element from the review history');
	echo  '</div>';
	}
	echo '</div>';
	}
